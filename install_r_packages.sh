...
R -e "require(devtools); install_version('plotly', version = '4.9.4.1', repos='http://cran.rstudio.com/', dependencies=T, Ncpus=parallel::detectCores(), quiet=FALSE)"
R -e "require(devtools); install_version('factoextra', version = '1.0.7', repos='http://cran.rstudio.com/', dependencies=T, Ncpus=parallel::detectCores(), quiet=FALSE)"
